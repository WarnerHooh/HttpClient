...
exports.OPTIONS = exports.PATCH = exports.DELETE = exports.PUT = exports.POST = exports.GET = exports.Body = exports.Header = exports.Query = exports.Path = exports.Headers = exports["default"] = void 0;
...
var HttpClient = function HttpClient() {
  var http = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : HttpClient.defaults.http;

  _classCallCheck(this, HttpClient);

  this.http = _HttpFactory["default"].resolve(http);
};
  ...
  return function (url) {
    return function (target, methodName, descriptor) {
      descriptor.value = function () {
        ...
        var realURL = "".concat(url); // RequestOptions
        ...
        var headers = brewByHeader(target, methodName, args); // return this.http.request({
        //   method,
        //   url: realURL,
        //   data: body,
        //   headers: {
        ...
        return this.http.request({
          ...
          url: realURL,
          data: body,
          headers: _objectSpread({}, headers, options ? options.headers : {}),
          responseType: options ? options.responseType : 'json',
